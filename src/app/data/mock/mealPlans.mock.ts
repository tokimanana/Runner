...
export const hotelMealPlans: Record<number, MealPlan[]> = {
  ...
  2: [
      ...
      inclusions: [
        {
          name: "Premium Dining",
          description:
            "Dine-around at all restaurants including specialty venues",
          isIncluded: true,
        },
        {
    ...
    },
    {
      ...
      description:
        "The most comprehensive all-inclusive experience with exclusive privileges and luxury services",
      mealTimes: [
        {
          name: "Breakfast",
          startTime: "07:00",
      ...
      inclusions: [
        {
          name: "Premium Dining",
          description:
            "Unlimited access to all restaurants including specialty venues with no restrictions",
          isIncluded: true,
        },
        {
          name: "Luxury Beverages",
          description:
            "Premium spirits, champagnes, and rare wines from our collection",
          isIncluded: true,
        },
        {
          name: "Exclusive Services",
          description:
            "24/7 butler service, private chef experiences, and exclusive dining setups",
          isIncluded: true,
        },
        {
          name: "Activities",
        ...
        },
        {
          name: "Transportation",
          description:
            "Complimentary seaplane transfers and luxury yacht services",
          isIncluded: true,
        },
      ],
      restrictions: [
  ...
  3: [
    // Pour Le Tropical Paradise Resort & Spa
    {
      id: "tropical-bb-plus",
      type: MealPlanType.BB_PLUS,
      name: "Tropical Breakfast Experience",
      description: "Petit-déjeuner enrichi avec spécialités locales",
      mealTimes: [
        {
          name: "Breakfast",
          startTime: "06:30",
          endTime: "10:30",
          location: "Creole Restaurant",
        },
      ],
      inclusions: [
        {
          name: "Petit-déjeuner Gourmet",
          description: "Buffet avec spécialités créoles et internationales",
          isIncluded: true,
        },
      ],
      restrictions: [
        "Service petit-déjeuner terminé strictement à 10:30",
        "Réservation requise pour le service en chambre",
      ],
      isActive: true,
    },
    {
      id: "tropical-ai-plus",
      type: MealPlanType.AI_PLUS,
      name: "Premium All Inclusive Experience",
      description: "Formule tout compris premium avec avantages exclusifs",
      mealTimes: [
        {
          name: "Breakfast",
          startTime: "07:00",
      ...
      inclusions: [
        {
          name: "Repas Complets",
          description: "Tous les repas dans les restaurants désignés",
          isIncluded: true,
        },
        {
          name: "Boissons Premium",
          description: "Sélection de boissons alcoolisées et non-alcoolisées",
          isIncluded: true,
        },
      ],
      restrictions: [
        "Certains vins et spiritueux premium en supplément",
        "Réservation requise pour les restaurants de spécialités",
        "Service tout compris valable jusqu'au départ",
      ],
      isActive: true,
    },
  ],
...
export const mealPlans = {
  ...
  getByHotelId(hotelId: number): MealPlan[] {
    return [...this.defaults, ...(this.hotelSpecific[hotelId] || [])];
  },
